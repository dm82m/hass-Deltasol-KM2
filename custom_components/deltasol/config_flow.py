...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        vol.Required(CONF_HOST, description={"suggested_value": "192.168.178.82"}): str,
        vol.Optional(CONF_PORT, description={"suggested_value": "80"}): str,
        vol.Optional(CONF_USERNAME, description={"suggested_value": "admin"}): str,
        vol.Optional(CONF_PASSWORD, description={"suggested_value": "p@ssw0rd"}): str,
        vol.Optional(CONF_API_KEY, description={"suggested_value": "00"}): str,
    }
)
...
async def validate_input(hass: HomeAssistant, data: dict[str, Any]) -> dict[str, Any]:
    ...
    api = API(data[CONF_HOST], data[CONF_PORT], data[CONF_USERNAME], data[CONF_PASSWORD], data[CONF_API_KEY])
    try:
